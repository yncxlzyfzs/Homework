    ...
    while (op)
    {
        ...
        switch (op)
        {
            ...
            case 6:
                ...
                {
                    printf ("Border Error: i should between 1 and List length...\n");
                    printf ("Press Enter to continue...\n");
                    getchar();
                    getchar();
                }
            ...
            case 8:
                ...
                printf ("Please input element: ");
                scanf (" %d", &e);
                pos = PriorElem (l, e, &tmp_e);
                if (pos == NULL)
                {
                    if (tmp_e == MEANINGLESS)
            ...
            case 10:
                ...
                if (status == ABNORMAL)
                    ...
                    printf ("Inserting failed: Position dosen't exist.\n");
                printf ("Press Enter to continue...\n");
                getchar();
                getchar();
                break;
    ...
    else
    {
        ...
        for (i=0; i<counter; i++)
        {
            ...
            for (j=0; j<l->length; j++)
            {
                ...
                fread (pos->next, sizeof (struct Node), 1, fp);
                pos = pos->next;
                pos->next = NULL;
            }
        }
...
Status SaveData (Table table)
{
    ...
    if (table->length)
    {
        ...
        for (i=0; i<table->length; i++)
        {
            l = table->lists[i];
            pos = l->next;
            fwrite (l, sizeof (struct Node), 1, fp);
            while (pos)
            {
                fwrite (pos, sizeof (struct Node), 1, fp);
                pos = pos->next;
            }
        }
    }
